...
const basePath = path_1.join(__dirname, '../fixtures');
...
japa_1.default.group('Fixtures', (group) => {
    group.before(() => {
    ...
    dirs.forEach((dir) => {
        ...
        japa_1.default(dir, (assert) => {
            ...
            const expectedCompiled = test_helpers_1.normalizeNewLines(fs_1.readFileSync(path_1.join(dirBasePath, 'compiled.js'), 'utf-8'));
             ...
             * Render output
             */
            const out = fs_1.readFileSync(path_1.join(dirBasePath, 'index.txt'), 'utf-8');
